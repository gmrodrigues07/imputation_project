...
if __name__ == "__main__":
    ...
    for dataset_name, data_path, target_col in datasets_to_process:
        ...
        # Part 2: 10 ITERATIONS - ACCURACY + F1
        print("\n\n" + "#"*100)
        print("PART 2: DOWNSTREAM TASK (ACCURACY + F1, 10 ITERATIONS)")
        print("#"*100)
        ...
        for iteration in range(n_iterations):
            ...
            # 1. NO HANDLING (listwise deletion)
            ...
            # 2. XGBOOST NATIVE (handles missing values) 
        ...
        # ✅ SAVE RESULTS (OUTSIDE ITERATION LOOP!)
